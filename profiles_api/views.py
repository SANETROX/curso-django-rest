...
class UserLoginApiView(ObtainAuthToken):
    """
        Crea Tokens de authenticacion de user
    """
    renderer_classes = api_settings.DEFAULT_RENDERER_CLASSES

class UserProfileFeeItemViewSet(viewsets.ModelViewSet):
    """"
        Maneja el leer, crear y actualizar el profiole feed
    """
    authentication_classes = (TokenAuthentication,)
    ...
    def perform_create(self, serializer):
        """
            Setear el perfil de user para el user que esta logueado
        """
